	...
	<div class="content-wrapper">
		...
		<div class="content container">
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						<form id="joinForm" action="/member/joinOK" method="post">
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row form-group">
									<div class="col-md-2 col-right">
										...
										아이디</label>&nbsp;<span style="color: #FA8072">*</span>
									</div>
									<div class="col-md-3">
										<input type="text" class="form-control" id="user_id" name="user_id">
										<!-- <p id="id_availability"></p> -->
									</div>
									<div class="col-md-7">
										<button id="btn_check_userId" class="btn btn-default" type="button">
										중복 확인</button>
										<small>영문소문자/숫자, 4~16자</small>
									</div>
								</div>
								<div class="row" id="form_idCheck" style="display: none;">
								...
								<div class="row form-group">
									<div class="col-md-2 col-right">
										<label for="user_pw" class="control-label">
										비밀번호</label>&nbsp;<span style="color: #FA8072">*</span>
									</div>
									<div class="col-md-3">
								...
								<div class="row form-group">
									<div class="col-md-2 col-right">
										<label for="user_pw_confirm" class="control-label">
										비밀번호확인</label>&nbsp;<span style="color: #FA8072">*</span>
									</div>
									<div class="col-md-3">
								...
								<div class="row form-group">
									<div class="col-md-2 col-right">
										<label for="user_nm" class="control-label">
										이름</label>&nbsp;<span style="color: #FA8072">*</span>
									</div>
									<div class="col-md-3">
								...
								<div class="row form-group">
									<div class="col-md-2 col-right">
										<label for="sample2_postcode" class="control-label">
										주소</label>&nbsp;
									</div>
									<div class="col-md-2">
										<input type="text" class="form-control" id="sample2_postcode" name="zip_num" readonly="readonly">
									</div>
									<div class="col-md-8">
								...
								<div class="row form-group">
									<div class="col-md-2 col-right">
										<label for="sample2_address" class="control-label">
										기본주소</label>&nbsp;
									</div>
									<div class="col-md-5">
										<input type="text" class="form-control" id="sample2_address" name="addr" readonly="readonly">
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-2 col-right">
										<label for="sample2_detailAddress" class="control-label">
										상세주소</label>&nbsp;
									</div>
									<div class="col-md-5">
										<input type="text" class="form-control" id="sample2_detailAddress" name="addr_dtl">
								...
								<div class="row form-group">
									...
									<div class="col-md-3">
										<div class="input-group">
						                	<input type="text" class="form-control" id="tel_phone" name="tel_phone">
										</div>
									</div>
								</div>
								<div class="row form-group">
								...
								<div class="row form-group">
									...
									<div class="col-md-10">
										...
										<label><input type="radio" name="email_rev_yn" value="Y" style="margin-left: 20px;" checked="checked"> 예</label>
			      						<label><input type="radio" name="email_rev_yn" value="N" style="margin-left: 20px;"> 아니오</label>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-md-6 col-right">
