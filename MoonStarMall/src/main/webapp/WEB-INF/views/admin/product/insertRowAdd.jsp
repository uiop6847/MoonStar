...
$(function(){
	...
	$("#btn_add").click(function(){
		productRowAdd($("#productRowAdd"), $("#productRowAddTemplate"));
	});
	
	var productRowAdd = function(target, templateObject){
		var template = Handlebars.compile(templateObject.html());
	...
	$("#btn_remove").click(function(){
		if($("#productRowAdd").length < 2) return;
		$("#productRowAdd").remove($("#productRowAdd").length-1);
	});
